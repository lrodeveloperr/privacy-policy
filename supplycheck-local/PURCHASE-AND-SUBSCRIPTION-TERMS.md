...
These Purchase and Subscription Terms supplement the [Terms of Use](TERMS-OF-USE.md). Apple and Google process Store transactions under their terms and display the binding transaction details before purchase.
...
The [Refund and Cancellation Policy](REFUND-AND-CANCELLATION-POLICY.md) applies. Cancellation and refund are different: cancellation stops a future Android renewal, while a refund request asks that a completed charge be returned. Store rules and mandatory law govern eligibility.
