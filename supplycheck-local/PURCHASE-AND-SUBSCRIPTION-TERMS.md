...
On Android, SupplyCheck Local may offer:
...
Cancellation stops future auto-renewal. Unless a refund, revocation, account hold or applicable law requires otherwise, access continues through the end of the period already paid. Uninstalling the App does not cancel the subscription.
...
## 5. Purchase authorization and pending transactions

You represent that you are authorized to use the selected store account and payment method. A purchase is complete only after the Store confirms it. A pending, declined, reversed, refunded, expired, held or revoked transaction may not provide paid access.

Do not attempt to falsify receipts, alter entitlement state, exploit billing errors or bypass paid limits. We may correct an erroneous entitlement or suspend access associated with fraud or a refunded or revoked transaction, subject to applicable law.

## 6. Offers and trials

No free trial, introductory price or promotional offer applies unless it is expressly shown by the Store before purchase. Any offer's eligibility, duration, conversion price and renewal terms are those displayed at checkout. The five-check free allowance is an App usage limit, not a time-based subscription trial and does not itself create an automatic charge.

## 7. Taxes, currency and store charges

Prices may be localized and may include or exclude taxes as shown by the Store. The Store determines accepted payment methods, currency conversion, tax collection and billing timing. We do not receive your full card or bank details.

## 8. Refunds and cancellation

See the [Refund and Cancellation Policy](REFUND-AND-CANCELLATION-POLICY.md). Store rules and mandatory law govern eligibility. Cancelling and requesting a refund are different actions: cancellation generally stops future renewal, while a refund request asks the Store to return a completed charge.

## 9. Changes

We may change prices or future plan features prospectively. Changes to an existing Android subscription are subject to Google Play's notice, consent and billing rules. A pricing change does not convert the Apple one-time unlock into a subscription or remove a valid existing Apple entitlement solely because the price changes.
